...
#import "SSUnrotateVC.h"
#import "SSModalUnrotateVC.h"
#import "SSPushUnrotateVC.h"


//屏幕的宽
#define kScreenWidth [UIScreen mainScreen].bounds.size.width

@interface SSUnrotateVC ()

@end

@implementation SSUnrotateVC
...
-(void)modalButtonclick{
    ...
    [self presentViewController:[[SSModalUnrotateVC alloc] init] animated:YES completion:nil];
}

-(void)pushButtonclick{
    
     [self.navigationController pushViewController:[[SSPushUnrotateVC alloc] init] animated:YES];
}
